// Tang Nano 20K: sys_clk=27MHz, fclk=86.4MHz, mclk=21.6MHz, hclk5=74.25MHz, hclk=14.85MHz
...
create_clock -name hclk5 -period 13.470 -waveform {0 6.735} [get_nets {hclk5}]
